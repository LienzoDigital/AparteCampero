...
export default function NewEvent() {
    ...
    return (
        <div className="max-w-md mx-auto mt-10">
            <Card className="text-center p-8 border-danger/20 dark:border-danger/20 shadow-red-500/10">
                ...
                <p className="text-secondary-500 dark:text-secondary-400 mb-8 leading-relaxed">
                    ...
                    <br />
                    <span className="font-bold text-danger mt-2 block">¡No se puede deshacer!</span>
                </p>

                <div className="flex flex-col gap-3">
                    <Button variant="danger" onClick={handleReset} className="w-full py-4 shadow-red-500/20">
